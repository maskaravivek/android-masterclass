...
import com.educative.android.hello.fragments.CustomDialogFragment1
import com.educative.android.hello.fragments.CustomDialogFragment2

class Lesson2DialogActivity : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?){
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_module_2_lesson_2_dialog)
